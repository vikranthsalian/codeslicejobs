  ...
  Widget build(BuildContext context) {
    return TextFieldBlocBuilder(
      ...
      contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
        ...
        focusedErrorBorder: _renderBorder(MetaColors.errorTextFieldBorderClr),
        errorBorder: _renderBorder(MetaColors.errorTextFieldBorderClr),
        ...
        errorStyle:const MetaStyle(fontColor:MetaColors.errorTextFieldBorderClr,fontSize: 12).getStyle(),
        filled: true,
        fillColor: backgroundColor,
        helperMaxLines: 1,
        suffixIcon: suffixIcon
